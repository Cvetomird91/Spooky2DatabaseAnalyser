...
debug:
	...
	g++  -o bin/Debug/Spooky2DatabaseAnalyser obj/Debug/main.o obj/Debug/src/Spooky2DatabaseAnalyser.o  -lboost_system -pthread -lboost_filesystem -m32 -lboost_system -lboost_filesystem -lboost_regex -m64 -pthread
...
release:
	...
	g++  -o bin/Release/Spooky2DatabaseAnalyser obj/Release/main.o obj/Release/src/Spooky2DatabaseAnalyser.o  -m32 -lboost_system -lboost_filesystem -s -m32 -lboost_system -lboost_filesystem -lboost_regex -m64 -pthread
